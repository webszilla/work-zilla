...
urlpatterns = [
    ...
    path("system-backup-manager/live-db-download", backup_manager_api_views.system_backup_manager_live_db_download, name="saas_admin_system_backup_manager_live_db_download"),
    ...
    path("system-backup-manager/blackblaze/settings", backup_manager_api_views.blackblaze_backup_settings, name="saas_admin_blackblaze_backup_settings"),
    path("system-backup-manager/blackblaze/run", backup_manager_api_views.blackblaze_backup_run, name="saas_admin_blackblaze_backup_run"),
    path("system-backup-manager/blackblaze/files", backup_manager_api_views.blackblaze_backup_files, name="saas_admin_blackblaze_backup_files"),
    path("system-backup-manager/blackblaze/download/<uuid:artifact_id>", backup_manager_api_views.blackblaze_backup_download, name="saas_admin_blackblaze_backup_download"),
    ...
    path("organizations/<int:org_id>/owner-password", api_views.organization_owner_password, name="saas_admin_org_owner_password"),
    ...
    path("tickets", api_views.ticket_list, name="saas_admin_ticket_list"),
    path("tickets/<int:ticket_id>", api_views.ticket_detail, name="saas_admin_ticket_detail"),
    path("tickets/<int:ticket_id>/reply", api_views.ticket_reply, name="saas_admin_ticket_reply"),
    path("tickets/<int:ticket_id>/status", api_views.ticket_status, name="saas_admin_ticket_status"),
    ...
    path("transfers/<int:transfer_id>/<str:action>", api_views.transfer_action, name="saas_admin_transfer_action"),
    path("transfers/<int:transfer_id>/receipt-clear", api_views.transfer_clear_receipt, name="saas_admin_transfer_receipt_clear"),
