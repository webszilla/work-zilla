...
urlpatterns = [
    ...
    path("tickets", api_views.org_tickets, name="api_org_ticket_list_create"),
    path("tickets/<int:ticket_id>", api_views.org_ticket_detail, name="api_org_ticket_detail"),
    path("tickets/<int:ticket_id>/reply", api_views.org_ticket_reply, name="api_org_ticket_reply"),
    path("tickets/<int:ticket_id>/status", api_views.org_ticket_status, name="api_org_ticket_status"),
    path("social-media-automation/overview", api_views.social_media_automation_overview, name="api_social_media_automation_overview"),
    path("social-media-automation/overview/", api_views.social_media_automation_overview, name="api_social_media_automation_overview_slash"),
    path("social-media-automation/companies", api_views.social_media_companies, name="api_social_media_companies"),
    path("social-media-automation/companies/", api_views.social_media_companies, name="api_social_media_companies_slash"),
    path("social-media-automation/companies/<int:company_id>", api_views.social_media_company_detail, name="api_social_media_company_detail"),
    path("social-media-automation/companies/<int:company_id>/", api_views.social_media_company_detail, name="api_social_media_company_detail_slash"),
    path("social-media-automation/connections", api_views.social_media_connections, name="api_social_media_connections"),
    path("social-media-automation/connections/", api_views.social_media_connections, name="api_social_media_connections_slash"),
    path("social-media-automation/connections/<str:platform>/disconnect", api_views.social_media_connection_disconnect, name="api_social_media_connection_disconnect"),
    path("social-media-automation/connections/<str:platform>/disconnect/", api_views.social_media_connection_disconnect, name="api_social_media_connection_disconnect_slash"),
    path("social-media-automation/content/generate", api_views.social_media_content_generate, name="api_social_media_content_generate"),
    path("social-media-automation/content/generate/", api_views.social_media_content_generate, name="api_social_media_content_generate_slash"),
    path("social-media-automation/posts", api_views.social_media_posts, name="api_social_media_posts"),
    path("social-media-automation/posts/", api_views.social_media_posts, name="api_social_media_posts_slash"),
    path("social-media-automation/posts/<int:post_id>/publish", api_views.social_media_post_publish, name="api_social_media_post_publish"),
    path("social-media-automation/posts/<int:post_id>/publish/", api_views.social_media_post_publish, name="api_social_media_post_publish_slash"),
