...
class Plan(models.Model):
    ...
    actual_monthly_price = models.FloatField(null=True, blank=True)
    actual_yearly_price = models.FloatField(null=True, blank=True)
    monthly_price = models.FloatField(null=True, blank=True)
    yearly_price = models.FloatField(null=True, blank=True)
    actual_usd_monthly_price = models.FloatField(null=True, blank=True, verbose_name="Actual USD monthly price")
    actual_usd_yearly_price = models.FloatField(null=True, blank=True, verbose_name="Actual USD yearly price")
