...
urlpatterns = [
    ...
    path("refund-policy/", views.refund_policy_view, name="website_refund_policy"),
    path("disclaimer/", views.disclaimer_view, name="website_disclaimer"),
    ...
    path("my-account/profile/check-username/", views.profile_check_username, name="account_profile_check_username"),
