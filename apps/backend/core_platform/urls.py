...
urlpatterns = [
    ...
    path("api/subscription/checkout-select", website_views.subscription_checkout_select),
    ...
    path("api/auth/signup", common_auth_api_views.api_signup),
    path("api/auth/forgot-password", common_auth_api_views.api_forgot_password),
    ...
    path("api/hrm/face-settings/", business_autopilot_api_views.hrm_face_settings),
    path("api/hrm/face-settings/update/", business_autopilot_api_views.hrm_face_settings_update),
    path("api/hrm/face-enrollment/status/", business_autopilot_api_views.hrm_face_enrollment_status),
    path("api/hrm/face-enrollment/capture/", business_autopilot_api_views.hrm_face_enrollment_capture),
    path("api/hrm/attendance/checkin-face/", business_autopilot_api_views.hrm_attendance_checkin_face),
    path("api/hrm/attendance/external-proof/verify/", business_autopilot_api_views.hrm_attendance_external_proof_verify),
    path("api/hrm/attendance/external-proof/reject/", business_autopilot_api_views.hrm_attendance_external_proof_reject),
